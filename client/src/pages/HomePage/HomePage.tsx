...
const gamesData = [
    ...
    { name: 'Bingo', image: 'https://images.unsplash.com/photo-1606092195730-5d7b9af1efc5?auto=compress&cs=tinysrgb&w=800', gameType: 'bingo', status: 'Available', category: 'Casual', tag: 'Easy', avatar: '🎱', rating: 4.8, difficulty: 'Easy', players: '2 players', time: '10-20 min' },
